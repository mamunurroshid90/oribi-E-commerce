...
import singleproduct from "../../components/dummyData/DummyProducts"
        ...
        <div className="max-w-container mx-auto">
          <div className="grid grid-cols-2 gap-10">
            {[0, 1, 2, 3].map((item, index) => (
              <div
                key={index}
                className="h-[780px] bg-slate-400 overflow-hidden"
              >
                <Image
              ...
              {newsingleproduct && newsingleproduct[0].discount == "false" ? (
                ...
                <>
                  ...
                  <span className="text-[#262626] text-xl font-dm font-bold ml-5 mt-5">
                    {Math.floor(
                      newsingleproduct &&
                        newsingleproduct[0].productprice -
                          (parseInt(
                            newsingleproduct && newsingleproduct[0].discount
                          ) *
                            parseInt(
                              newsingleproduct &&
                                newsingleproduct[0].productprice
